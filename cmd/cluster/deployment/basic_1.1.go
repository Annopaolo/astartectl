...
func init() {
	astarteBasicProfile10.Compatibility.MaxAstarteVersion, _ = semver.NewVersion("1.1.99")
	astarteBasicProfile10.Compatibility.MinAstarteVersion, _ = semver.NewVersion("1.1.0")
