...
func init() {
	astarteBurstProfile10.Compatibility.MaxAstarteVersion, _ = semver.NewVersion("1.1.99")
	astarteBurstProfile10.Compatibility.MinAstarteVersion, _ = semver.NewVersion("1.1.0")
